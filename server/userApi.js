...
conn.query(sql,[params.shuliang,params.jieshao], function(err, result) {
...
router.post('/ser', (req, res) => {
    ...
    conn.query(sql, [params.shuangliang], function(err, result) {
    ...
    router.post('/checkCurr', (req, res) => {
        ...
        conn.query(sql, [params.shuliang,], function(err, result) {
        ...
        router.post('/checkCurr1', (req, res) => {

            var sql = $sql.user.checkCurr1;
